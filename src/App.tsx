...
import { Camera, Upload, Sparkles, Download, RefreshCw, User, Briefcase, CheckCircle2 } from 'lucide-react';
...
export default function App() {
  ...
  const generateAvatar = async () => {
    ...
    try {
      ...
      setError("Server is busy or image is too complex. Please try again in a few seconds.");
    } finally {
